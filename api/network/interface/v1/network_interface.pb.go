...
var file_api_network_interface_v1_network_interface_proto_depIdxs = []int32{
	...
	1,  // 7: network.interface.v1.NetworkInterface.Register:output_type -> network.interface.v1.RegisterReply
	3,  // 8: network.interface.v1.NetworkInterface.Login:output_type -> network.interface.v1.LoginReply
	5,  // 9: network.interface.v1.NetworkInterface.Logout:output_type -> network.interface.v1.LogoutReply
	7,  // 10: network.interface.v1.NetworkInterface.GetUser:output_type -> network.interface.v1.GetUserReply
	11, // 11: network.interface.v1.NetworkInterface.AddFollower:output_type -> network.interface.v1.AddFollowerReply
